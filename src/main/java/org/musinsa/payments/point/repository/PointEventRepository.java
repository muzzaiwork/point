...
public interface PointEventRepository extends JpaRepository<PointEvent, Long> {
     ...
     */
    List<PointEvent> findByOrderAndDetailTypeOrderByIdDesc(Order order, PointEventType detailType);

    List<PointEvent> findByOrderAndPointAndDetailType(Order order, Point point, PointEventType detailType);
}
