...
- **POINT**:
  ...
  | :--- | :--- | :--- | :--- | :--- | :--- |
  | 1 | `8da1...` | 1000 | 1000 | FREE | `2999-12-31T23:59:59` |
...
- **POINT**:
  ...
  | :--- | :--- | :--- | :--- | :--- | :--- |
  | 1 | `8da1...` | 1000 | 1000 | FREE | `2999-12-31T23:59:59` |
  | 2 | `3f2b...` | 500 | 500 | FREE | `2999-12-31T23:59:59` |
...
- **POINT**: (A 우선 소진)
  ...
  | :--- | :--- | :--- | :--- | :--- | :--- |
  | 1 | `8da1...` | 1000 | **0** | FREE | `2999-12-31T23:59:59` |
  | 2 | `3f2b...` | 500 | **300** | FREE | `2999-12-31T23:59:59` |
- **POINT_USAGE**:
  | id (PK) | pointKey (UUID) | orderNo | totalAmount | usageDate |
  | :--- | :--- | :--- | :--- | :--- |
  | 1 | `9e5d...` | A1234 | 1200 | `2026-03-30T21:15:00` |
- **POINT_USAGE_DETAIL**: (1원 단위 추적)
  | id (PK) | usageId (FK) | accumulationId (FK) | amount |
  | :--- | :--- | :--- | :--- |
  | 1 | 1 (C) | 1 (A) | 1000 |
  | 2 | 1 (C) | 2 (B) | 200 |
...
- **POINT**:
  ...
  | :--- | :--- | :--- | :--- |
  | 1 | `8da1...` | 0 | **`2026-03-29T21:11:00` (만료)** |
...
- **POINT**:
  ...
  | 2 | `3f2b...` | 500 | **400** | FREE | `2999-12-31...` | B의 사용분(200) 중 100원 복구 |
  | 3 | `5c7a...` | 1000 | **1000** | FREE | `2999-12-31...` | **A 취소분 1000원 신규 적립 (별칭: E)** |
...
- **POINT**:
  ...
  | :--- | :--- | :--- | :--- | :--- | :--- |
  | 1 | `8da1...` | 1000 | 0 | `2026-03-29...` | 만료 |
  | 2 | `3f2b...` | 500 | **500** | `2999-12-31...` | B의 남은 사용분 100원 복구 |
  | 3 | `5c7a...` | 1000 | 1000 | `2999-12-31...` | 신규 적립 건 유지 |
