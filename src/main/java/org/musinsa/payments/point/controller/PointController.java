...
public class PointController {
    ...
    public PointDto.Response<String> accumulate(@RequestBody PointDto.AccumulateRequest request) {
        ...
        return new PointDto.Response<>("적립 성공", pointKey);
    }
    ...
    public PointDto.Response<String> use(@RequestBody PointDto.UseRequest request) {
        String pointKey = pointService.use(
                request.getUserId(),
                request.getOrderNo(),
                request.getAmount()
        );
        return new PointDto.Response<>("사용 성공", pointKey);
    }
    ...
    public PointDto.Response<Void> cancelUsage(
        ...
        return new PointDto.Response<>("사용 취소 성공", null);
    }
}
