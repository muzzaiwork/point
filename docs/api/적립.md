...
| 테이블 | 필드 | 변경 전 | 변경 후 | 비고 |
| :--- | :--- | :--- | :--- | :--- |
| **USER_ACCOUNT** | `totalPoint` | `5,000` | `6,000` | 전체 잔액 1,000P 증가 |
...
| 테이블 | 필드 | 상태 | 결과 | 비고 |
| :--- | :--- | :--- | :--- | :--- |
| **USER_ACCOUNT** | `totalPoint` | `5,000` | **변화 없음** | 예외 발생 (400 Bad Request) |
...
| 테이블 | 필드 | 상태 | 결과 | 비고 |
| :--- | :--- | :--- | :--- | :--- |
| **USER_ACCOUNT** | `totalPoint` | `995,000` | **변화 없음** | 예외 발생 (400 Bad Request) |
