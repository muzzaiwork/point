 ...
 * <ul>
 *   <li>{@code E0000}: 성공</li>
 *   <li>{@code E4000 ~ E4099}: 400 Bad Request (잘못된 요청)</li>
 *   <li>{@code E4040 ~ E4049}: 404 Not Found (리소스 없음)</li>
 *   <li>{@code E4090 ~ E4099}: 409 Conflict (비즈니스 로직 충돌)</li>
 *   <li>{@code E5000 ~ E5099}: 500 Internal Server Error (서버 오류)</li>
 * </ul>
 */
@Getter
