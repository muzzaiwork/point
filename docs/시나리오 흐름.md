...
| 테이블 | 데이터 |
| :--- | :--- |
| **USER_ACCOUNT** | `userId: user1`, `totalPoint: 0` |
...
- **USER_ACCOUNT**: `totalPoint: 300 + 1100 = 1400`
...
- **USER_ACCOUNT**: `totalPoint: 1400 + 100 = 1500`
